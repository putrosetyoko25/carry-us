...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/carousel_2.jpg'); ?>');">
    <div class="container">
        ...
        <form action="<?php echo site_url('shop/checkout/order'); ?>" method="POST">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 ftco-animate">
                    <h3 class="mb-4 billing-heading">Data Customer</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled value="<?php echo $customer->address; ?>"></input>
                        <input name="address" type="hidden" class="form-control" id="address" value="<?php echo $customer->address; ?>"></input>
                    </div>
                    ...
                    <div class="row mt-5 pt-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="radio">
                                        <label><input type="hidden" name="payment" class="mr-2" value="1" checked></label>
                                    </div>
                                </div>
                            </div>
