...
class Order_model extends CI_Model
{
    ...
    {
        return $this->db->get_where('kursus', array('id_kursus' => $id))->result_array();
        // return $this->db->where('id_kursus', $id)->get('kursus')->num_rows();
    }

    public function get_nama_course($id)
    {
        return $this->db->where('id_kursus', $id)->get('courses')->result_array();
    }
